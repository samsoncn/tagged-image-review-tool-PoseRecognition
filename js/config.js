var tools = {
    labelling : {
        ...
        //     type: "visibility",
        //     title  : "Visibility",
        //     desp : "Allow user to input number that represents type of visibility",
        //     icon : "visibility.svg",
        //     // drawable : true,
        //     create : function(){
        //         // return prompt("0- Not labeled, \n 1- Labeled but not visible, \n 2- Labeled and visible", "0, 1, or 2");
        //         return nonVisiblePoint()
        //         // return not_visibile;
        //     },
        //     validate: function(el){
        //         return true;
...
function getPointToDraw(position, container, canvasOffset) {
    ...
    var containerOffset = {
        ...
        // v: parseInt(prompt("0- Not labeled, \n 1- Labeled but not visible, \n 2- Labeled and visible", "0, 1, or 2")) || 0
    }
...
var suggestedCategories = ["person"];
